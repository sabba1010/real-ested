...
const HowItWorks = () => {
  return (
    <section className="py-16 bg-slate-50 rounded-[2rem] shadow-2xl overflow-hidden">
        ...
        <div className="rounded-[2rem] bg-white p-8 shadow-2xl border border-slate-200">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {steps.map((item, index) => (
              <div
                key={index}
                className="text-center p-8 border border-slate-200 rounded-[1.75rem] bg-slate-50 shadow-lg transition-transform duration-300 hover:-translate-y-1"
              >
